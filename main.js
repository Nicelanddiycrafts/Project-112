...
classifier = ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/ksOn03_2q/model.json ", modelLoaded)
...
if(error){
    ...
    if(results[0].label == "Thumbs Up"){
        document.getElementById("p1spa").innerHTML = "&#128077;  This means good job or yes";
    }
    else if(results[0].label == "Awesome"){
        document.getElementById("p1spa").innerHTML = "&#128076; Really good/Amazing";
    }
    else if(results[0].label == "Up"){
        document.getElementById("p1spa").innerHTML = "&#128070; Up ";
    }
